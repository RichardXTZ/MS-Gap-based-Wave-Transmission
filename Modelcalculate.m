...
%     strCellsel = 'Cellsel';
%     myCellsel = myComp.selection.create(strCellsel, 'Explicit');
%     myCellsel.label(strCellsel);
%     myCellsel.set([4 8 9 10]);
...
%     myBarPMLsel.set('ymin',{'-bar_sizey-cav_h-lambda_bar'});
    ...
    mySolidTOsel.set('input',{strBarsel, strBarPMLsel});
    ...
    myLemm1.set('nu', 'nu_bar');
    myLemm1.set('rho_mat', 'userdef');
    myLemm1.set('rho', 'rho_bar');
